...
@MapperScan(basePackages = "com.hy.center.mapper")
...
public class CenterStageApplication {
    public static void main(String[] args) {
        SpringApplication.run(CenterStageApplication.class,args);
    }
}
