 ...
 * @Description: $- -$ #-->
 * @Author: 寒夜
 * @CreateDate: 2020/11/21 10:54
 * @UpdateUser: 寒夜
 * @UpdateDate: 2020/11/21 10:54
 * @UpdateRemark: 修改内容
 * @Version: 1.0
 */
@FeignClient(value = "fun-box-account-service",fallbackFactory = AccountFallbackFactory.class)
public interface AccountServiceFeignClient extends IAccountService {
}
