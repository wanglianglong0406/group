...
import com.hy.task.parser.ElasticJobConfParser;
...
@EnableConfigurationProperties(com.hy.task.autoconfigure.JobZookeeperProperties.class)
public class JobParserAutoConfiguration {

	@Bean(initMethod = "init")
	public ZookeeperRegistryCenter zookeeperRegistryCenter(com.hy.task.autoconfigure.JobZookeeperProperties jobZookeeperProperties) {
	...
	@Bean
	public ElasticJobConfParser elasticJobConfParser(com.hy.task.autoconfigure.JobZookeeperProperties jobZookeeperProperties, ZookeeperRegistryCenter zookeeperRegistryCenter) {
